...
const Separator = React.forwardRef((_a, ref) => {
    ...
    return (<SeparatorPrimitive.Root ref={ref} decorative={decorative} orientation={orientation} className={(0, utils_1.cn)("shrink-0 bg-stone-200 dark:bg-stone-800", orientation === "horizontal" ? "h-[1px] w-full" : "h-full w-[1px]", className)} {...props}/>);
});
