...
const Card = React.forwardRef((_a, ref) => {
    ...
    return (<div ref={ref} className={(0, utils_1.cn)("rounded-xl border border-stone-200 bg-white text-stone-950 shadow dark:border-stone-800 dark:bg-stone-950 dark:text-stone-50", className)} {...props}/>);
});
exports.Card = Card;
...
const CardDescription = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (<p ref={ref} className={(0, utils_1.cn)("text-sm text-stone-500 dark:text-stone-400", className)} {...props}/>);
});
